...
def movie_crawl(movie_name):
        ...
        # 최신순 클릭
        latest = driver.find_element(By.XPATH, f'//*[@id="main_pack"]/div[3]/div[2]/div/div/div[4]/div[2]/div[1]/div/ul/li[2]/a')
        latest.click()
        ...
        try:
            ...
            filename = f"./data/{movie_name.split(':')[0]}_latest2_review_1000000.pkl"
...
if __name__ == "__main__":
    ...
    for movie_name in movie_li['영화명'][:2]:
        try :
